...
<div class="container-fluid" style="margin-top: 10px;">
	<form action="DeliveryTable" method="post">
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="btn-group btn-group-lg rounded ">
					...
					<a href="TakeAway.jsp" class="btn btn-sm btn-success "><img
						src="images/coffee.png"> <span class="badge">Take
							away</span></a> 
					<a href="Delivery.jsp" class="btn btn-sm btn-success active"><img
						src="images/logistics-delivery-truck-and-clock (1).png"> <span
						class="badge">Delivery</span></a>
		...
		<div class="row">
			...
			<div class="col-md-3 ">
				<div class="card scrollbar-dusty-grass"
					...
					<div class="card-body bg-light scroll scrollbar-ripe-malinka">
						...
						<div class="list-group">
							<a class="list-group-item list-group-item-action tableli"
				...
				<div class="row" style="margin-top: 10px;">
					<div class="col-md-12">
						 <input
							type="hidden" value="b" id="clist" name="clist">
						<button class="b1" type="submit"
							style="height: 130px; width: 100%;">Take Order</button>
					</div>
				</div>
			</div>
		</div>
