              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				  ...
				  <li><a><i class="fa fa-credit-card"></i>Transactions<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="kot.jsp?id=1">KOT(Kitchen Order Ticket)</a></li>
					  <li><a href="billing.jsp?id=1">Billing</a></li>
					  <li><a href="adjustment.jsp?id=1">Settlement</a></li>
					  <li><a href="todayspecial.jsp?id=1">Today's Special</a></li>
