              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				  ...
				  <li><a><i class="fa fa-user"></i> Masters<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="./../masters/employeemaster.jsp?id=1">Employee Master</a></li>
                      <li><a href="./../masters/tablemaster.jsp?id=1">Table Master</a></li>
                      <li><a href="./../masters/itemmaster.jsp?id=1">Item Master</a></li>
					  <li><a href="./../masters/suppliermaster.jsp?id=1">Supplier Master</a></li>
					  <li><a href="./../masters/purchasemaster.jsp?id=1">Purchase Master</a></li>
					  <li><a href="./../masters/kotmaster.jsp?id=1">KOT Master</a></li>
					  <li><a href="./../masters/departmentmaster.jsp?id=1">Department Master</a></li>
					  <li><a href="./../masters/taxmaster.jsp?id=1">Tax Master</a></li>
					  <li><a href="./../masters/customermaster.jsp?id=1">Customer Master</a></li>
                    </ul>
                  </li>
				  ...
				  <li><a><i class="fa fa-file"></i>Report<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="gst.jsp?id=1">GST Reports</a></li>
                      <li><a href="stockreport.jsp?id=1">Stock Report</a></li>
					  <li><a href="sales.jsp?id=1">Sales Report</a></li>
					  <li><a href="cancelorder.jsp?id=1">Cancelled Orders Day Wise</a></li>
					  <li><a href="incentives.jsp?id=1">Employees Incentives</a></li>
					  <li><a href="managers.jsp?id=1">Managers Report</a></li>
	                </ul>
                  </li>
