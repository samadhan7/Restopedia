        ...
        <!-- Restaurant Maintainance--><br><br>
	        ...
	        <div class="panel panel-primary">
	            <div class="panel-heading ">
	                <h3 class="panel-title">Store Maintenance</h3>
	            </div>
                ...
                <div class="col-md-12">
                    <div class="panel" style="border-color: " style="background-color: #a9a9a9">
                        <ul class="nav nav-tabs" style="border-bottom-color: blue">
                            ...
                            <li class="nav-item">
                                <a href="#Complementory" class="nav-links" role="tab" data-toggle="tab"><button type="button" class="btn btn-primary">Complementory Guest</button></a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="Chain">  
                              ...
                              <form>
								  <div class="form-group">
								    <label for="code" class="col-sm-4 control-label">Guest id:</label>
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="guestid" placeholder="Guest Id" name="Guest Id">
								    </div>
								  </div>
                            ...
                            <!-- Starts Complementry tab-->
                            
                            <div role="tabpanel" class="tab-pane" id="Complementry">
